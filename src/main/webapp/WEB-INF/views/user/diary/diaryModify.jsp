	        		...
	        		<div class="middle-container">
	          			...
	          			<div class="middle-box">
							...
							<div class="diary-container2">
								...
								<form method="post" enctype="multipart/form-data" action="/diary/diaryUpdate" onsubmit="return check(this)">
								<input type="hidden" name="diary_seqno" value="${diary.diary_seqno}">
									<table>									
									<tr>
			 						<td><textarea style="width:100%" cols="100" rows="12" name="content">${diary.content}</textarea></td>
									</tr>
