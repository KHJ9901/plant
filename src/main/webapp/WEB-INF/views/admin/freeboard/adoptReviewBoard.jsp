		...
		<div class="bdbox">
			...
			<div class="bdtitle">
				...
				<select class="wholeCategory" onchange="#">
			  		...
			  		<option value="분양등록자ID">분양등록자ID</option>
			  		<option value="후기작성자ID">후기작성자ID</option>
				</select>
			...
			<div class="bdbody">
				<div class="bdlist">
					<div class="top">
						...
						<div class="plantNum">후기번호</div>
						<div class="plantName">식물이름</div>
						<div class="plantWdate">분양신청일</div>
						<div class="plantCount">조회수</div>
						<div class="memBdName">분양등록자ID</div>
						<div class="memBdId">후기작성자ID</div>
					</div>
					...
					<div class="bdBottom">
						...
						<div class="plantName" id="post">첫번째 분양 받은 식물</div>
						<div class="plantWdate">2022-08-01</div>
						<div class="plantCount">22</div>
						<div class="memBdName">khj1234</div>
